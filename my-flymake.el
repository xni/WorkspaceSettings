...
`flymake-make-err-menu-data'."
  (popup-tip (car (car (car (cdr menu-data))))))
;;  (if (featurep 'xemacs)
...
(defun flymake-cpp-init ()
  (let* ((temp-file   (flymake-init-create-temp-buffer-copy
	 ...
	 (local-file  (file-relative-name
                       temp-file
                       (file-name-directory buffer-file-name))))
    (list "/home/stromsund/WorkspaceSettings/cpplint.sh" (list local-file))))
...
(defun flymake-python-init ()
  (let* ((temp-file   (flymake-init-create-temp-buffer-copy
	 ...
	 (local-file  (file-relative-name
                       temp-file
                       (file-name-directory buffer-file-name))))
    (list "/home/stromsund/WorkspaceSettings/pycheckers" (list local-file))))
